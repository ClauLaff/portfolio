  ...
  return(
    <main>
      <div className="main">
        <section>
          <div className="about">
            ...
            {props.language === 'fr'?(
              ...
              <p className="aboutText"> After undertaking a career change and retraining in IT, I've gained good skills in web development and I keep learning about this profession with a keen interest. <br/>
        ...
        <section>
          <div>
            <h1 className="training-title">Formation</h1>
